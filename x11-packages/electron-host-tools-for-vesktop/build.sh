...
TERMUX_PKG_DESCRIPTION="Build cross-platform desktop apps with JavaScript, HTML, and CSS (Used by Vesktop, Host Tools)"
...
termux_step_make_install() {
	...
	mkdir -p "$TERMUX_PREFIX/lib/vesktop/"
	rm -rf $TERMUX_PREFIX/lib/vesktop/node_headers
	cp -Rf out/Release/gen/node_headers $TERMUX_PREFIX/lib/vesktop/
