...
TERMUX_PKG_DESCRIPTION="Qt6 Positioning Library"
...
TERMUX_PKG_DEPENDS="libc++, opengl, qt6-qtbase (>= ${TERMUX_PKG_VERSION}), qt6-qtdeclarative (>= ${TERMUX_PKG_VERSION}), qt6-qtpositioning (>= ${TERMUX_PKG_VERSION})"
...
termux_step_host_build() {
	...
	# the qt6-qtlocation-cross-tools subpackage during on-device building
